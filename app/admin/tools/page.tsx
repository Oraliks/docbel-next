  ...
  return (
    <div className="admin-tools-page">
      <div className="admin-page-header">
        <div>
          <h1>{t('admin.tools.manage')}</h1>
          <p>Manage tools and calculators</p>
        </div>
          ...
          <table className="admin-table">
            ...
            <tbody>
              {tools.map(tool => (
                <tr key={tool.slug}>
                  <td>
                    <strong>{tool.titleFr}</strong>
                    <br />
                    <small>{tool.titleNl}</small>
                  </td>
                  <td><code>{tool.slug}</code></td>
                  <td className="actions">
                    <Link href={`/admin/tools/${tool.slug}/edit`} className="admin-link-btn">
                      ✏️ Edit
                    </Link>
                    <button
